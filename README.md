...
Learn more about technical release history in the [Quake Rally Research Essays](research/research.md).
...
Quake Kart (QKart) | Steve Bond aka "wedge",<br>John Guthrie "Choryoth" | [kart.jpg](bin/extensions/kart.jpg)<br>[kartspec.txt](bin/extensions/kartspec.txt)<br>testkart.zip
